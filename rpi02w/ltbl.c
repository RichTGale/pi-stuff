...
int main()
{
    ...
    ardcom_read_str(ac, &brightness);

    if ((val = atoi(brightness)) > 100)
    {
        system("sudo cp /home/richard/Programs/motion-day.conf /etc/motion ; sudo killall motion ; sudo motion");
    }
